using Baitaptulam1._1_TMD.Models;
using System;
...
namespace Baitaptulam1.1_TMD.Models
{
    public class ProductsRepository_TMD
    {
        ...
        private static readonly List<Category_TMD> dataCategory = new List<Category_TMD>()
        {
            new Category_TMD
            {
                CategoryId_TMD = "L01",
                CategoryName_TMD = "Lẩu"
            },
            new Category_TMD
            {
                CategoryId_TMD = "T01",
                CategoryName_TMD = "Tôm"
            }
        };
        public IList<Product_TMD> SearchCategory_TMD(string CategoryId_TMD)
        {
            return data.Where(p => p.CategoryId_TMD.EndsWith(CategoryId_TMD)).ToList();
        }
