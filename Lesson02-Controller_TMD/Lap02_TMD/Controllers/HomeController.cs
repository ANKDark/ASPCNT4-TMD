...
namespace Lap02_TMD.Controllers
{
    public class HomeController : Controller
    {
        ...
        public JsonResult TestJsonResult()
        {
            ...
            listStudent.Add(new Student() { ID = 001, Name = "Trần Minh Đức", ClassName = "ANK" });
        ...
        {
            byte[] fileBytes =
            System.IO.File.ReadAllBytes(Server.MapPath("~/Content/VideoDemo.mp4"));
